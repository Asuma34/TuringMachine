...
class TuringMachine {
 public:
  TuringMachine(Tape& t, std::vector<State>& s) : tape(t), states(s), time(0) {
    alphabet.push_back("#");
    alphabet.push_back("0");
    alphabet.push_back("1");
  }
  TuringMachine() : time(0) {
    alphabet.push_back("#");
    alphabet.push_back("0");
    alphabet.push_back("1");
  }
  TuringMachine(Tape& t) : tape(t), time(0) {
    alphabet.push_back("#");
    alphabet.push_back("0");
    alphabet.push_back("1");
  }
  TuringMachine(Tape& t, std::vector<State>& s, std::vector<std::string> alph) : tape(t), alphabet(alph), states(s), time(0) {}
  ~TuringMachine() {}
  void Show() const;
